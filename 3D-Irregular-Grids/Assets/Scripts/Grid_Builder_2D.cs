...
public class Grid_Builder_2D : MonoBehaviour
{
    ...
    [InspectorButton("OnButtonClicked", ButtonWidth = 250)]
    ...
    private void CreateConnections()
    {
        ...
        {
            if (diagonal.x + 1 < HORIZONTAL_GRID_SIZE && diagonal.y + 1 < VERTICAL_GRID_SIZE)
            {
                /*
                 * get point at (x,y+1)
    ...
    private Point GetPoint(float x, float y, float z)//todo test
    {
